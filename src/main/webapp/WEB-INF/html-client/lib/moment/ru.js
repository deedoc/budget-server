...
moment.lang('ru', {
    months : moment.localization.ru.monthsCaseReplace,
    monthsShort : "янв_фев_мар_апр_май_июн_июл_авг_сен_окт_ноя_дек".split("_"),
    weekdays : moment.localization.ru.weekdaysCaseReplace,
    ...
    relativeTime : {
        ...
        past : "%s назад",
        s : "несколько секунд",
        m : moment.localization.ru.relativeTimeWithPlural,
        mm : moment.localization.ru.relativeTimeWithPlural,
        h : "час",
        hh : moment.localization.ru.relativeTimeWithPlural,
        d : "день",
        dd : moment.localization.ru.relativeTimeWithPlural,
        M : "месяц",
        MM : moment.localization.ru.relativeTimeWithPlural,
        y : "год",
        yy : moment.localization.ru.relativeTimeWithPlural
    },
    ordinal : '%d.',
    week : {
